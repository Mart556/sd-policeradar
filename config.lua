return {
    NotificationType = "custom",  -- native/custom (native means built in notify from the radar itself, custom will mean it'll use ShowNotification function)
